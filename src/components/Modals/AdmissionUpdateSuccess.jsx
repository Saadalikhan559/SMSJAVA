...
const AdmissionUpdateSuccess = ({ handleCloseOnly, handleCloseAndNavigate }) => {
    return (
        <div className="modal modal-open bg-black/30 backdrop-blur-sm">
            <div className="modal-box text-center">
                <h3 className="font-bold text-2xl mb-4">Update Successful!</h3>
                <i className="fa-regular fa-circle-check text-green-500 text-5xl mb-4"></i>
                <p className="mb-6 text-gray-600">
                    Your admission form details has been updated successfully.
                </p>
...
export default AdmissionUpdateSuccess
