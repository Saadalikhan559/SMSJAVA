...
const StudentFeeAndUnpaidSummary = () => {
    ...
    return (
        <div className="min-h-screen p-5 bg-gray-50 flex flex-row gap-6 h-screen">
                    ...
                    <>
                        ...
                        {!details.monthly_summary || filteredSummary.length === 0 ? (
                            <div className="text-center text-gray-600">
                                No fee records found for {details.student_name}.
                            </div>
                        ) : (
                                    ...
                                    item.year_level_fees_grouped?.map((group) =>
                                        group.fees?.map((fee) => (
                                            <tr key={`${item.id}-${group.year_level}-${fee.id}`} className="hover:bg-blue-50">
                                                ...
                                                <td className="px-4 py-3 text-sm text-red-500">₹{item.due_amount}</td>
