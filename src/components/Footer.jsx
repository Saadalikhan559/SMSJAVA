...
const Footer = () => {
  return (
    <>
      ...
      <div className="h-20" /> {/* approximate footer height */}

      <footer className="footer sm:footer-horizontal footer-center bg-base-100 text-base-content p-4 shadow-sm fixed bottom-0 left-0 w-full z-50">
