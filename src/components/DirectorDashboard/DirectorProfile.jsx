...
const DirectorProfile = () => {
  ...
  const onSubmit = (data) => {
    console.log("Updated director data:", data);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={directorData.first_name || 'Not provided'}
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={directorData.middle_name || 'Not provided'}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={directorData.last_name || 'Not provided'}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={directorData.email || 'Not provided'}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={directorData.phone_no || 'Not provided'}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={directorData.gender || 'Not provided'}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
