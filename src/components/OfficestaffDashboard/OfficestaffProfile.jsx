...
const OfficestaffProfile = () => {
  // Static office staff data with the new payload structure
  const staffData = {
    "id": 5,
    "phone_no": "09632587425",
    "gender": "Male",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={staffData.middle_name || 'N/A'}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                type="text"
                value={departmentMap[staffData.department] || `Department ${staffData.department}`}
                className="input input-bordered w-full text-sm"
                readOnly
              />
            </div>
