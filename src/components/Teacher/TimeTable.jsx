...
const TimeTable = () => {
  ...
  <div className="max-w-7xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
    <div className="mb-4">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 text-center mb-4 border-b border-gray-300 dark:border-gray-700 pb-4">
              ...
              <div className="shadow-sm rounded-lg">
                <table className="min-w-full border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                    {classData.papers.length === 0 ? (
                      <tr>
                        <td colSpan={6} className="text-center py-6 text-gray-500 dark:text-gray-400">
                          No papers assigned for this class.
                        </td>
                      </tr>
                    ) : (
                      classData.papers.map((paper, index) => {
                        ...
                        const duration = `${durationHours > 0 ? `${durationHours} hr` : ""} ${
