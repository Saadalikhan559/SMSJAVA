      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="bgTheme text-white px-6 py-4">
          <h1 className="text-2xl font-bold">
            {details.student.first_name} {details.student.last_name}'s Admission Details
          </h1>
        </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p>{details.student.first_name} {details.student.middle_name} {details.student.last_name}</p>
              </div>
              <div>
                <p className="font-medium">Date of Birth:</p>
                <p>{details.student.date_of_birth}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>{details.student.blood_group}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>{details.student.category}</p>
              </div>
              <div>
                <p className="font-medium">Height/Weight:</p>
                <p>{details.student.height} ft / {details.student.weight} kg</p>
              </div>
              <div>
                <p className="font-medium">Siblings:</p>
                <p>{details.student.number_of_siblings}</p>
              </div>
              <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p>{details.guardian_type}</p>
              </div>
              <div>
                <p className="font-medium">Name:</p>
                <p>{details.guardian.first_name} {details.guardian.last_name}</p>
              </div>
              <div>
                <p className="font-medium">Phone:</p>
                <p>{details.guardian.phone_no}</p>
              </div>
              <div>
                <p className="font-medium">Email:</p>
                <p>{details.guardian.email}</p>
              </div>
              <div>
                <p className="font-medium">Occupation:</p>
                <p>{details.guardian.occupation}</p>
              </div>
              <div>
                <p className="font-medium">Annual Income:</p>
                <p>₹{details.guardian.annual_income?.toLocaleString()}</p>
              </div>
              <div>
                <p className="font-medium">Qualification:</p>
                <p>{details.guardian.qualification}</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p>{details.previous_school_name}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>{details.emergency_contact_n0}</p>
              </div>
              <div>
                <p className="font-medium">TC Letter:</p>
                <p>{details.tc_letter}</p>
              </div>
            </div>
          </div>
