...
// //             console.log("Fetched officestaff:", data); // Debugging
// //             setofficestaff(data);
// //         } catch (err) {
// //             console.error("Error fetching officestaff:", err);
...
//         <div className="min-h-screen p-5 bg-gray-50">
//             {/* Teachers */}
//             <div className="bg-white p-6 rounded-lg shadow-lg max-w-screen-md mx-auto mb-10">
//                 <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">
//                     <i className="fa-solid fa-person-chalkboard mr-2"></i>
//                     Teachers
//                 </h1>
//                 {error && (
//                     <div className="text-red-600 text-center mb-4 font-medium">
