...
//     reset({
//       first_name: profileData.java_user?.first_name || "",
//       middle_name: profileData.java_user?.middle_name || "",
//       last_name: profileData.java_user?.last_name || "",
//       email: profileData.java_user?.email || "",
//       gender: profileData.java_user?.gender || "",
...
//         <div className="flex space-x-2">
//           <div className="w-3 h-3 bgTheme rounded-full animate-bounce"></div>
//           <div className="w-3 h-3 bgTheme rounded-full [animation-delay:-0.2s] rounded-full animate-bounce"></div>
//           <div className="w-3 h-3 bgTheme rounded-full [animation-delay:-0.4s] rounded-full animate-bounce"></div>
//         </div>
//         <p className="mt-2 text-gray-400 text-sm">Loading data...</p>
//       </div>
//     );
...
//             <div className="space-y-6">
//               {[
//                 ["First Name", profileData.java_user?.first_name, faUser],
//                 ["Middle Name", profileData.java_user?.middle_name, faSignature],
//                 ["Last Name", profileData.java_user?.last_name, faSignature],
//                 ["Email", profileData.java_user?.email, faEnvelope],
//                 ["Father's Name", profileData.father_name, faUser],
//                 ["Mother's Name", profileData.mother_name, faUser],
//               ].map(([label, value, icon], i) => (
//                 <div className="flex flex-col gap-1" key={i}>
...
//             <div className="space-y-6">
//               {[
//                 ["Gender", profileData.java_user?.gender, faVenusMars],
//                 ["Religion", profileData.religion, faPrayingHands],
//                 ["Category", profileData.category, faIdCard],
//                 ["Height (ft)", profileData.height, faRulerVertical],
//                 ["Weight (kg)", profileData.weight, faWeight],
...
const StudentProfile = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axiosInstance.put(`/s/students/student_my_profile/`, formData, {
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      {[
                        ...
                        <div className="flex flex-col gap-1" key={i}>
                          ...
                          <input
                            type={type}
                            {...register(field, {
                              required: field === "middle_name" ? false : `${label} is required`,
                            })}
                  ...
                  <div className="flex justify-end gap-4 mt-6">
                    <button
                      ...
                      className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white dark:bg-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600"
                    >
                      Cancel
                    </button>
                    <button type="submit" className="btn bgTheme text-white">
